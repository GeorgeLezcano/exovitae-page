  ...
  return (
    <div className="sectionShell flushTop">
      ...
      >
        ...
        >
          <strong>Exovitae</strong> is a 2D multiplayer survival game set on a
          ...
          scenarios. Explore diverse biomes, forge alliances, and carve your 
          path in a dynamic, living world where survival is only the beginning.
        </p>
      </section>
    </div>
  );
